...
mod tests {
    ...
    fn render_launchd_plist_escapes_xml_and_parser_unescapes_socket_path() {
        ...
        assert_eq!(
            super::service::socket_path_from_launchd_plist(&plist),
            Some(socket_path)
        );
    }
    ...
    fn socket_path_from_launchd_plist_returns_none_for_malformed_input() {
        assert_eq!(
            super::service::socket_path_from_launchd_plist("<plist></plist>"),
            None
        );
        assert_eq!(
            super::service::socket_path_from_launchd_plist(
    ...
    #[test]
    fn launchd_command_args_match_install_refresh_and_uninstall_mapping() {
        let service_path =
            PathBuf::from("/Users/me/Library/LaunchAgents/com.tracedecay.daemon.plist");

        assert_eq!(
            super::service::launchd_install_command_args(
                "gui/501",
            ...
            vec![
                ...
                vec![
                    "enable".to_string(),
                    "gui/501/com.tracedecay.daemon".to_string()
                ],
                vec![
                    "kickstart".to_string(),
                    "-k".to_string(),
        ...
        assert_eq!(
            super::service::launchd_refresh_command_args(
                "gui/501",
                "gui/501/com.tracedecay.daemon",
                &service_path
            )
        ...
        assert_eq!(
            super::service::launchd_uninstall_command_args("gui/501/com.tracedecay.daemon"),
            vec![
                vec![
                    "bootout".to_string(),
                    "gui/501/com.tracedecay.daemon".to_string()
